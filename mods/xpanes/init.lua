...
function xpanes.register_pane(name, def)
	...
	minetest.register_node(":xpanes:" .. name .. "_flat", {
		...
		sounds = def.sounds,
		use_texture_alpha = (def.use_texture_alpha == true) and "blend" or def.use_texture_alpha or "opaque",
		node_box = {
			type = "fixed",
...
xpanes.register_pane("pane", {
	...
	textures = {"ws_glass.png", "", "xpanes_edge.png"},
	inventory_image = "ws_glass.png",
	wield_image = "ws_glass.png",
	sounds = ws_core.node_sound_glass_defaults(),
	groups = {snappy=2, cracky=3, oddly_breakable_by_hand=3},
	recipe = {
		{"ws_core:glass", "ws_core:glass", "ws_core:glass"},
		{"ws_core:glass", "ws_core:glass", "ws_core:glass"}
	}
})
...
xpanes.register_pane("bar", {
	...
	textures = {"iron_bars.png", "", "iron_bars.png"},
